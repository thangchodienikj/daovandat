<main class="main" style="width: 78%; margin: 0 auto;">
    <br>
    <br>
    <div class="box_title" style="font-size: 25px; text-align: center; margin-bottom: 10px;">Giao thành công</div> <br>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($listdh as $cart){
                            ...
                            if ( $cart['tinhtrangdh'] == 0){
                                echo'   <a href="index.php?act=tinhtrang&id='.$id_don_mua.'&tinhtrangdh=4" class="btn btn-danger btn-block">Hủy đơn</a>
                                                        <a href="index.php?act=chitiet&id='.$id_don_mua.'" class="btn btn-primary btn-block ">Chi tiết</a>';
                            }
                            if ( $cart['tinhtrangdh'] == 1){
                                echo'<a href="index.php?act=chitiet&id='.$id_don_mua.'" class="btn btn-primary btn-block ">Chi tiết</a>';
                            }
                            if ( $cart['tinhtrangdh'] == 2){
                                echo'   <a href="index.php?act=tinhtrang&id=' . $id_don_mua . '&tinhtrangdh=3&tinhtrangdm=1" class="btn btn-primary btn-block ">Đã nhận</a>
                                                        <a href="index.php?act=chitiet&id='.$id_don_mua.'" class="btn btn-primary btn-block ">Chi tiết</a>';
                            }
