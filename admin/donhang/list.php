<main class="main" style="width: 78%; margin: 0 auto;">
    <br>
    <br>
    <div class="box_title" style="font-size: 25px">DANH SÁCH ĐƠN HÀNG</div> <br>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center col-md-2">NGƯỜI MUA</th>
                                ...
                                foreach ($listDH as $sanpham){
                                    ...
                                    echo'<tr>
                                                ...
                                                <td class="text-center col-md-2">'.$ten_sach.'</td>
